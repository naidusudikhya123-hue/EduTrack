...
public class QuizServiceImpl implements QuizService {
    ...
    // ===================== GET USER ATTEMPTS =====================
    @Override
    @CircuitBreaker(name = "assessmentUserLookup", fallbackMethod = "userLookupFallback")
    ...
    // ===================== FALLBACK =====================
    public List<UserDTO> userLookupFallback(String userId, Throwable throwable) {
        ...
        return attempts.stream().map(attempt -> {
            ...
            UserDTO dto = new UserDTO();
            dto.setUserId(userId);
            dto.setUserName(fallbackUser.getUserName());
            dto.setQuizId(attempt.getQuizId());
            dto.setScore(attempt.getScore());
            dto.setTitle(quiz.getTitle());
